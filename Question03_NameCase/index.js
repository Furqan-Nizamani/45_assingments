...
// step 2
let titleCaseSentance = "";
// step 3
for (let i = 0; i < words.length; i++) {
    titleCaseSentance += words[i].charAt(0).toUpperCase() + words[i].slice(0).toLowerCase() + " ";
}
